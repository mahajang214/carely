...
function BrowseServices() {
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      {/* Filters */}
      <div className="flex flex-wrap gap-4 mb-10 items-center justify-end">
        <label htmlFor="category-filter" className="text-xl text-gray-700">
          Filter :
        </label>
        ...
        {services?.map((service) => (
          ...
          >
            ...
            <div className="flex justify-between items-center ">
              <span className="text-lg bg-white text-[#0336A6]  py-1 rounded-full font-medium">
                {service.pricingType}
              </span>

              <span className="font-bold bg-white text-[#0336A6] text-lg">
                ₹{service.basePrice}
              </span>
            </div>
          </div>
                    ...
                    <div>
                      ...
                      <div className="font-medium mt-2">
                        <div className="flex gap-3 flex-wrap">
                          {serviceDetails?.requiredQualification?.length > 0 ? (
    ...
    ${
      selectedDuration
        ? "bg-[#003A9E] text-white hover:bg-[#03307d]"
      ...
      `}
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                className="px-4 py-2 cursor-pointer rounded-lg bg-[#003A9E] text-white hover:bg-[#023080]"
              >
